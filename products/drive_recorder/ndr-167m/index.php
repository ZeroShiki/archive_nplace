...
<div class="container" id="wrap">
	...
	<div id="carouselIndicators" class="carousel slide my-3" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<img class="w-100 d-block mx-auto" src="../../../img/drive_recorder/NDR-167M_front.jpg" alt="正面">
			</div>
			<div class="carousel-item">
				<img class="w-100 d-block mx-auto" src="../../../img/drive_recorder/NDR-167M_back.jpg" alt="背面">
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-6 mb-4">
			<img src="../../../img/drive_recorder/NDR-167M_kakunin.jpg" alt="自動LCDオフ" class="img-fluid">
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-6 mb-4">
			<img src="../../../img/drive_recorder/NDR-167M_LCD_off.jpg" alt="本体 – その場で確認" class="img-fluid">
		</div>
	</div>
