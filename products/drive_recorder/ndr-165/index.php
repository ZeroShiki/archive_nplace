...
<div class="container" id="wrap">
	<nav aria-label="breadcrumb" role="navigation" class="bg-light">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">NDR-165</li>
		</ol>
	</nav>
	<p class="">DIADORA NDR-165</p>
	<div id="carouselIndicators" class="carousel slide my-3" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<img class="w-100 d-block mx-auto" src="../../../img/drive_recorder/NDR-165_front.jpg" alt="正面">
			</div>
			<div class="carousel-item">
				<img class="w-100 d-block mx-auto" src="../../../img/drive_recorder/NDR-165_back.jpg" alt="背面">
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-6 mb-4">
			<p>録画／撮影したファイルは車内その場で確認することができます。<br>microSDカードを取り外して、パソコンに接続して映像／画像を閲覧することもできます。<br>（拡張子：MOVが再生可能な動画プレーヤー、JPGが表示できるフォトビューワーが必要です。）</p>
			<p class="small mb-0">※再生メニューを操作している場合、録画はできません。</p>
		</div>
		<div class="col-md-6 mb-4">
			<img src="../../../img/drive_recorder/NDR-165_LCD_off.jpg" alt="本体 – その場で確認" class="img-fluid">
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-6 mb-4">
			<img src="../../../img/drive_recorder/NDR-165_kakunin.jpg" alt="自動LCDオフ" class="img-fluid">
		</div>
	</div>
	...
	<table class="table table-sm">
		<tbody>
			...
			<tr>
				<th scope="row">カメラ</th>
				<td>100万画素 HD<br>対角130°／水平100°／垂直80°</td>
			</tr>
			<tr>
				<th scope="row">解像度</th>
