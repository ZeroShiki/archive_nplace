...
<div class="container" id="wrap">
	...
	<div class="justify-content-center">
		<img class="w-75 d-block mx-auto" src="../../../img/carnavi/DNC-558A_front.jpg" alt="正面">
	</div>
	...
	<div class="row justify-content-center">
		...
		<a href="http://support.nplace.jp/download/firmware/dnc-558a/"><button type="button" class="btn btn-info m-1 mb-2 btn-lg">ファームウェア</button></a>
	</div>
