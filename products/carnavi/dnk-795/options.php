	...
	<section id="">
		<nav aria-label="breadcrumb" role="navigation" class="bg-light">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="index.php">DNK-795</a></li>
				<li class="breadcrumb-item active" aria-current="page">オプション</li>
			</ol>
		</nav>
		<p class="">DIANAVI DNK-795 オプション</p>
		...
		<div class="row mb-5">
			...
			<?php require_once '../option/cg19-set-non.html'; ?>
			<?php require_once '../option/op-fac-non.html'; ?>
