...
<div class="container" id="wrap">
	<nav aria-label="breadcrumb" role="navigation" class="bg-light">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">DNK-7626J</li>
		</ol>
	</nav>
	<p class="">DIANAVI DNK-7626J</p>
	<div id="carouselIndicators" class="carousel slide my-3" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<img class="w-100 d-block mx-auto" src="../../../img/carnavi/DNK-7626J_front.jpg" alt="正面">
			</div>
			<div class="carousel-item">
				<img class="w-100 d-block mx-auto" src="../../../img/carnavi/DNK-7626J_back.jpg" alt="背面">
			</div>
			<div class="carousel-item">
				<img class="w-100 d-block mx-auto" src="../../../img/carnavi/DNK-7626J_dashboard.jpg" alt="ダッシュボード">
			</div>
		</div>
	...
	<div class="row justify-content-center">
		...
		<a href="http://nplace.jp//wp-content/uploads/downloads/manuals/navigation/DNK-7626J_manual_web_v2.pdf" target="_blank"><button type="button" class="btn btn-info m-1 mb-2 btn-lg">取扱説明書</button></a>
	</div>

	<div class="row justify-content-center">
		<a href="#map-2016sp"><button type="button" class="btn btn-outline-dark m-1 btn-sm">2016年度版マップ春</button></a>
		<a href="#rurubu2016"><button type="button" class="btn btn-outline-dark m-1 btn-sm">2016年度版るるぶDATA</button></a>
	...
	<?php
		require_once '../details/map-2016sp.html';
	...
	<?php
		require_once '../details/nk06f15_315_rurubu.html';
		require_once '../details/map-2016sp-db.html';
