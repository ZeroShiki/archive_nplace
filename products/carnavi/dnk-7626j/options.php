	...
	<section id="">
		<nav aria-label="breadcrumb" role="navigation" class="bg-light">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="index.php">DNK-7626J</a></li>
				<li class="breadcrumb-item active" aria-current="page">オプション</li>
			</ol>
		</nav>
		<p class="">DIANAVI DNK-7626J オプション</p>
		...
		<div class="row mb-5">
			...
			<div class="col-lg-3 col-md-4 col-6">
				<div class="option mb-4">
					<img class="card-img-top" src="../../../img/carnavi/DNK-7626J_manual_pict.jpg" alt="取扱説明書">
					<div class="card-body-option">
						<p class="card-title">取扱説明書</p>
						<h4 class="card-text">OP-M7626</h4>
			...
			<div class="col-lg-3 col-md-4 col-6">
				<div class="option mb-4">
					<img class="card-img-top" src="../../../img/carnavi/rurubu_driveguide_pict.jpg" alt="るるぶ特別編集ドライブガイド">
					<div class="card-body-option">
						<p class="card-title">るるぶ特別編集ドライブガイド</p>
						<p class="card-text">非売品</p>
						<p class="card-text">JTBパブリッシング特別編集によるドライブガイドです。</p>
					</div>
				</div>
			</div>
		</div>
