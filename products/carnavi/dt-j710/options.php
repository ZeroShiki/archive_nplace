	...
	<section id="">
		<nav aria-label="breadcrumb" role="navigation" class="bg-light">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="index.php">DT-J710</a></li>
				<li class="breadcrumb-item active" aria-current="page">オプション</li>
			</ol>
		</nav>
		<p class="">DIANAVI DT-J710 オプション</p>
		<h3 class="mb-4 mt-3 pb-2 border-bottom"><strong>同梱オプション</strong></h3>
		<div class="row mb-5">
			<?php
				require_once '../option/dt-j710-stand-non.html';
				require_once '../option/op-fd7-non.html';
				require_once '../option/dt-j710-holder-non.html';
				require_once '../option/dt-j710-touchpen-non.html';
