	...
	<section id="">
		<nav aria-label="breadcrumb" role="navigation" class="bg-light">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="index.php">DNA-520</a></li>
				<li class="breadcrumb-item active" aria-current="page">オプション</li>
			</ol>
		</nav>
		<p class="">DIANAVI DNA-520 オプション</p>
		...
		<div class="row mb-5">
			...
			<div class="col-lg-3 col-md-4 col-6">
				<div class="option mb-4">
                	<img class="card-img-top" src="../../../img/carnavi/DNA-520_holder.jpg" alt="専用ホルダー">
        	...
        	<div class="col-lg-3 col-md-4 col-6">
				<div class="option mb-4">
					<img class="card-img-top" src="../../../img/carnavi/DNA-520_touchpen.jpg" alt="タッチペン">
					<div class="card-body-option">
