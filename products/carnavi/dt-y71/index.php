...
<div class="container" id="wrap">
	<nav aria-label="breadcrumb" role="navigation" class="bg-light">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">DT-Y71</li>
		</ol>
		</nav>
	<p class="">DIANAVI DT-Y71</p>
	<div id="carouselIndicators" class="carousel slide my-3" data-ride="carousel">
	  	<div class="carousel-inner">
			...
			<div class="carousel-item active">
			  	<img class="w-100 d-block mx-auto" src="../../../img/carnavi/DT-Y71_front.jpg" alt="正面">
			</div>
			<div class="carousel-item">
			  	<img class="w-100 d-block mx-auto" src="../../../img/carnavi/DT-Y71_back.jpg" alt="背面">
			</div>
	  	</div>
	...
	<div class="row justify-content-center">
		...
		<a href="http://nplace.jp/wp-content/uploads/downloads/manuals/navigation/DT-Y71_manual_web_v1.pdf" target="_blank"><button type="button" class="btn btn-info m-1 mb-2 btn-lg">ハードマニュアル</button></a>
	</div>
