...
<div class="container" id="wrap">
	<nav aria-label="breadcrumb" role="navigation" class="bg-light">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">DNC-055A</li>
		</ol>
	</nav>
	<p class="">DIANAVI DNC-055A</p>
	<div id="carouselIndicators" class="carousel slide my-3" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<img class="w-100 d-block mx-auto" src="../../../img/carnavi/DNC-055A_front.jpg" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="w-100 d-block mx-auto" src="../../../img/carnavi/DNC-055A_back.jpg" alt="Second slide">
			</div>
		</div>
	...
	<div class="row justify-content-center">
		...
		<a href="http://nplace.jp/wp-content/uploads/downloads/manuals/navigation/DNC-055A_manual_web_v5.pdf" target="_blank"><button type="button" class="btn btn-info m-1 mb-2 btn-lg">取扱説明書</button></a>
	</div>
